...
import {
  ...
  RouterLinkActive,
  RouterModule
} from "./chunk-IFJJMW56.js";
import {
  DomSanitizer
} from "./chunk-YFO5BJJZ.js";
import "./chunk-GMXUGVGU.js";
import {
  AsyncPipe,
  DOCUMENT,
  NgClass,
...
var _CdkTrapFocus = class _CdkTrapFocus {
  ...
  constructor(_elementRef7, _focusTrapFactory, _document4) {
    this._elementRef = _elementRef7;
...
var _backdropClick, _document2, _rendererFactory, _renderer3, _unListen, _scrollbarWidth, scrollbarWidth_get, _isRTL, isRTL_get, _scrollBarVisible;
var _BackdropService = class _BackdropService {
  ...
  hideScrollbar() {
    if (__privateGet(this, _scrollBarVisible)) {
      ...
      __privateGet(this, _renderer3).setStyle(__privateGet(this, _document2).body, `padding-${__privateGet(this, _isRTL, isRTL_get) ? "left" : "right"}`, this.scrollbarWidth);
  ...
  resetScrollbar() {
    ...
    __privateGet(this, _renderer3).removeStyle(__privateGet(this, _document2).body, `padding-${__privateGet(this, _isRTL, isRTL_get) ? "left" : "right"}`);
    __privateSet(this, _scrollBarVisible, true);
  }
  onClickHandler() {
...
var _ProgressBarDirective = class _ProgressBarDirective {
  constructor() {
    __privateAdd(this, _renderer4, void 0);
...
var _ProgressComponent = class _ProgressComponent {
  constructor() {
    ...
    __privateAdd(this, _elementRef5, void 0);
...
var _TabDirective = class _TabDirective {
  constructor() {
    ...
    __privateAdd(this, _elementRef6, void 0);
